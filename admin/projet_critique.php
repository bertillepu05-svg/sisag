...
// Calcul du retard moyen pour l'export PDF
$sql_retard_moyen = "SELECT AVG(DATEDIFF('$aujourdhui', date_fin)) as retard_moyen FROM projet WHERE statut = 'En retard'";
$result_retard = $conn->query($sql_retard_moyen);
$retard_moyen_data = $result_retard->fetch_assoc();
$retard_moyen = $retard_moyen_data['retard_moyen'];
...
$sql_projets = "SELECT id_projet, nom_projet, commune, quartier, ministere, statut, budget, 
                ...
                ORDER BY jours_retard DESC, id_projet ASC 
            ...
            <div class="col-lg-10 col-md-9 p-4">
                ...
                <?php else: ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <p class="alert-heading"><i class="bi bi-exclamation-triangle-fill"></i> <strong>Projets nécessitant une attention immédiates</strong></p>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0">Projets Critiques</h3>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php echo $retard_moyen ? round($retard_moyen) . ' jours' : '0 jour'; ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="projetsCritiquesTable">
                                ...
                                <tbody>
                                    <?php if($result_projets->num_rows > 0): ?>
                                        <?php while($ligne = $result_projets->fetch_assoc()): ?>
                                            ...
                                            ?>
                                            <tr class="<?php echo $classe_retard; ?>">
                                                ...
                                                <td><span class="badge badge-statut badge-en-retard"><?php echo $ligne["statut"]; ?></span></td>
                                                ...
                                                <td><span class="<?php echo $couleur_retard; ?>"><?php echo $jours_retard; ?> jour(s)</span></td>
                                                <td>
                                                    <div class="progress">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="modifier_critique.php?id=<?php echo $ligne['id_projet']; ?>" class="btn btn-warning btn-sm">
