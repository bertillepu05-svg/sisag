...
if (isset($_GET['arreter_suivi']) && !empty($_GET['arreter_suivi'])) {
    ...
    $sql_delete = "DELETE FROM projets_suivis WHERE id_utilisateur = ? AND id_projet = ?";
    $stmt_delete = $conn->prepare($sql_delete);
    $stmt_delete->bind_param("ii", $user_id, $id_projet);
...
$sql_suivis = "SELECT p.id_projet, p.nom_projet, p.commune, p.quartier, p.ministere, 
                       p.statut, p.budget, p.date_debut, p.date_fin, p.avancement, 
                       p.photo, p.descript, p.objectif, ps.date_suivi
                FROM projet p
                INNER JOIN projets_suivis ps ON p.id_projet = ps.id_projet
                WHERE ps.id_utilisateur = ?
                ORDER BY ps.date_suivi DESC";
$stmt_suivis = $conn->prepare($sql_suivis);
$stmt_suivis->bind_param("i", $user_id);
$stmt_suivis->execute();
            ...
            <div class="col-lg-2 col-md-3 p-0 sidebar bg-dark text-white">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php" data-page="dashboard">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="profil.php" data-page="profile">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="navbar-text" style="font-size : 20px;">
                            <i class="bi bi-person"></i> <?php echo $_SESSION['user_nom'] ?? 'Utilisateur'; ?>
                        </span>
                    </div>
                </div>
                <hr>
                        ...
                        <?php while($projet = $result_suivis->fetch_assoc()): ?>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card project-card h-100">
                                    <img src="photos/<?php echo $projet['photo'] ?: 'default.jpg'; ?>" 
                                         class="project-image" 
