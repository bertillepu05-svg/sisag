<?php
    ...
    $sqlTotal = "SELECT COUNT(*) as total FROM administrateur";
    $resultTotal = $conn->query($sqlTotal);
    $total = $resultTotal->fetch_assoc()['total'];
    
    // Compter les actifs
    $sqlActif = "SELECT COUNT(*) as count FROM administrateur WHERE statut = 'Actif'";
    $resultActif = $conn->query($sqlActif);
    $actif = $resultActif->fetch_assoc()['count'];
    
    // Compter les inactifs
    $sqlInactif = "SELECT COUNT(*) as count FROM administrateur WHERE statut = 'Inactif'";
