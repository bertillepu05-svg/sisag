...
$comments_per_page = 6; // 2 lignes × 3 colonnes = 6 commentaires par page
$current_page = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
$offset = ($current_page - 1) * $comments_per_page;

// Récupérer les commentaires par statut avec pagination
try {
    ...
    $stmt_pending->bindValue(':offset', $offset, PDO::PARAM_INT);
    ...
    $stmt_approved->bindValue(':offset', $offset, PDO::PARAM_INT);
    ...
    $stmt_rejected->bindValue(':offset', $offset, PDO::PARAM_INT);
                ...
                <div class="tab-content" id="commentTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="pending" role="tabpanel">
                        <?php if (count($commentaires_attente) > 0): ?>
                            ...
                            <?php if ($total_pages_pending > 1): ?>
                                <nav aria-label="Pagination commentaires en attente">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <?php if ($current_page < $total_pages_pending): ?>
                                            <li class="page-item">
                    ...
                    <div class="tab-pane fade" id="approved" role="tabpanel">
                        <?php if (count($commentaires_approuves) > 0): ?>
                            ...
                            <?php if ($total_pages_approved > 1): ?>
                                <nav aria-label="Pagination commentaires approuvés">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($current_page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?php echo $current_page - 1; ?>" aria-label="Précédent">
                                        ...
                                        <?php if ($current_page < $total_pages_approved): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?php echo $current_page + 1; ?>" aria-label="Suivant">
                                                    <span aria-hidden="true">&raquo;</span>
                                                </a>
                    ...
                    <div class="tab-pane fade" id="rejected" role="tabpanel">
                        <?php if (count($commentaires_rejetes) > 0): ?>
                            ...
                            <?php if ($total_pages_rejected > 1): ?>
                                <nav aria-label="Pagination commentaires rejetés">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($current_page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?php echo $current_page - 1; ?>" aria-label="Précédent">
                                        ...
                                        <?php for ($i = 1; $i <= $total_pages_rejected; $i++): ?>
                                            <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                                                <a class="page-link" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        
                                        <?php if ($current_page < $total_pages_rejected): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?php echo $current_page + 1; ?>" aria-label="Suivant">
                                                    <span aria-hidden="true">&raquo;</span>
                                                </a>
