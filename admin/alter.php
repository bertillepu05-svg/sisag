...
<body>
                    ...
                    <div class="col-xl-2 col-md-6 mb-3">
                        <div class="card stat-card card-region">
                            <div class="card-body">
                                ...
                                <select class="form-select" id="dateTrier" name="date">
                                    <option value="">--Selectionner</option>
                                    <option value="">Croissant</option>
                                    <option value="">Decroissant</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="" class="d-flex">
                                    <input type="text" class="form-control me-2" id="rechercheFilter" name="recherche" placeholder="Nom projet, commune, ministère...">
                    ...
                    <div class="table-container">
                        <table class="table table-hover" id="regionProjectsTable">
                            ...
                            <tbody id="table-body">
                                ...
                                $sql = "SELECT id_citoyen, photo1, nom, prenom, sexe, email, telephone, commune, quartier, profession, statut, date_signUp FROM citoyen ORDER BY id_citoyen ASC";
                                $result = $conn->query($sql); 

                                if($result->num_rows > 0){
                                    while($ligne = $result->fetch_assoc()){
                                    echo "<tr>"; 
                                        echo "<td>".$ligne["id_citoyen"]."</td>";
                                        // COLONNE PHOTO AJOUTÉE
                                        echo "<td>";
                                        if (!empty($ligne["photo1"]) && file_exists($ligne["photo1"])) {
                                            echo "<img src='".htmlspecialchars($ligne["photo1"])."' class='photo-candidate' alt='Photo candidat'>";
                                        } else {
                                            echo "<img src='../photos/default/avatar.jpg'class='photo-candidate' alt='Photo candidat'>";
                                        }
                                        echo "</td>";
                                    ...
                                    echo "<tr><td colspan='9' class='text-center'>Aucun citoyen trouvé</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
    ...
    <script>
            ...
            function mettreAJourCompteurs() {
                ...
                xhr.open('GET', 'compter_citoyen.php', true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        try {
